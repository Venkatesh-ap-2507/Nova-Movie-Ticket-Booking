...
export default function App({ navigation }) {
    ...
    return (
        ...
        <SafeAreaView>
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10, flexWrap: 'wrap', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ flexDirection: 'row', gap: 10 }}>
                            <TouchableOpacity onPress={goToAddMoviePage}>
                                <Ionicons name="add" size={24} color="black" />
                            </TouchableOpacity>
                            <TouchableOpacity onPress={goToMovieBoard}>
                        ...
                        {movies?.map((movie, index) => (
                            ...
                            >
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    ...
                                    {/* <Text style={{ fontSize: 12, color: '#333' }}>{movie.job}</Text> */}
            ...
            {/* <Button title="Cast" onPress={() => navigation.navigate('Cast')} />
            <Button title="Movie" onPress={() => navigation.navigate('MovieBoard')} /> */}
